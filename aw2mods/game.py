...
class DamageMatrix(Struct):
    ...
    def __init__(self, position, parent):
        super().__init__(position, parent)
        for i, name in enumerate(AdvanceWarsTwo.UNIT_ORDER + ["dived_sub"]):
...
class AdvanceWarsTwo(Rom):
    UNIT_ORDER=["infantry","mech","mdtank","antitank","tank","recon","apc","heavyneotank","patrol","artillery","rockets","striker",
